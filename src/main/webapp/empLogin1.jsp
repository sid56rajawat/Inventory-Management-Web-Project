...
<div class="bg-gray-400">
  ...
  <div class="bg-gray-600 mx-auto text-center w-1/2 py-5 shadow-xl rounded-3x1 my-96 max-w-2xl">
    <form action="http://localhost:9009/JavaMiniProject/emplogin" method="post">
  	...
  	<form action="http://localhost:9009/JavaMiniProject/empregister" method="get">
      	<input class="bg-blue-300 text-xl font-semibold px-4 py-1 rounded-lg hover:bg-blue-800 hover:text-white" type="submit" value="Register" name="register" />
      </form><br>
